...
{{ systemd_user_service('passfuse-gcsfuse', 'passfuse for gcsfuse', passfuse_gcsfuse_exec) }}
...
{{ systemd_user_service('gcsfuse', 'GCSFuse', gcsfuse_exec, gcsfuse_unit, gcsfuse_env, gcsfuse_options) }}
